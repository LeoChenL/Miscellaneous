...
for Binary Search and O(K*logK) to insert the numbers in the Min Heap, as well
as to sort the output array.

Space complexity #
The space complexity will be O(K), as we need to put a maximum of 2K numbers in
the heap.
*/
