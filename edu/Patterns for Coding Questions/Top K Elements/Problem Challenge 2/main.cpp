...
Each task will take one CPU interval to execute but once a task has finished, it
...
Space complexity #
The space complexity will be O(N), as in the worst case, we need to store 
all the ‘N’ tasks in the HashMap.
*/
