...
/*
Explanation #
BigArray only supports copy semantic. This is a performance issue in line 54.
The containers of the standard template library have copy-semantic.

This means that the containers want to copy all elements. If BigData had
implemented move semantic implemented, it would have been used automatically in
line 54 since the constructor call BigArray(1000000000) creates an rvalue.
*/
